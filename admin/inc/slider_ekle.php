...
<div class="col-lg-12">
    <div class="panel panel-default ">
        <div class="panel-heading bg-gradient-primary text-warning pl-4">
            <span class="ml-2">slider Ekleme Bölümü</span>
        </div>
...
$kontrol = $query->rowCount();
    if($kontrol){
        echo '<div class="alert alert-warning"><strong><span style="color:red;">'.$adi.'</span></strong> isminde baska bir slider mevcut; lütfen özgün bir slider ismi giriniz!</div>';
           ...
           ");
            ...
            if($ok){
            echo '<div class="alert alert-success">slider basarıyla eklendi, yönlendiriliyorsunuz..</div>';
            }else{
            echo '<div class="alert alert-danger">slider     eklenirken bir hata olustu</div>';
            }
          } 
            ...
            <div class="col-8">
                ...
                <div style="text-align: center;">
                    <button style="position: relative; right: 0;" type="submit" class="btn btn-primary my-2 ">Slider Ekle</button>
                </div>
            </div>
            </form>
            <?php
